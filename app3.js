...
document.addEventListener("scroll",function(){
  if(sectionScroll.getBoundingClientRect().top>=-400&&
  sectionScroll.getBoundingClientRect().top<=150){
  if(sectionScroll.classList.contains('class'))
    sectionScroll.classList.add("your-active-class")
   sectionScroll.style.backgroundColor="green"
   }
else{sectionScroll.classList.remove("your-active-class")
